...
use xrpl_wasm_std::host::{bn254_mul_helper, bn254_pairing_helper};
...
/*
   ...
   for (i, input_bytes) in public_bytes.chunks(SCALAR_SIZE_UNCOMPRESSED).enumerate() {
       ...
       unsafe{
           xrpl_std::host::bn254_mul_helper(
               ic_bytes_le.as_ptr(),
               ic_bytes_le.len(),
               scalar_le.as_ptr(),
               scalar_le.len(),
       ...
       unsafe{
           xrpl_std::host::bn254_add_helper(
               add_buf.as_ptr(),
               add_buf.len(),
               mul_buf.as_ptr(),
               mul_buf.len(),
   ...
   // trace_data("  Data: ", &vk_x_bytes, DataRepr::AsHex);
   ...
   //     10, 54, 58, 11, 138, 191, 186, 35, 11, 53,
   //     62, 233, 9, 35, 81, 241, 188, 80, 101, 146,
   //     41, 187, 241, 224, 141, 139, 146, 224, 16, 231,
   //     123, 131, 7, 251, 245, 245, 230, 155, 253, 129,
   //     150, 205, 134, 151, 116, 245, 156, 44, 9, 19,
   //     187, 133, 153, 139, 69, 244, 118, 207, 148, 89,
   //     131, 208, 226, 64
   // ];


   // let result = vk_x_bytes.as_slice() == &EXPECTED[..];
   ...
   unsafe{
       let _ = xrpl_std::host::bn254_neg_helper(                    // negate a
           proof_a_buf.as_ptr(),
           proof_a_buf.len(),
...
*/
   ...
   const EXPECTED: [u8; 768] = [
       13, 122, 222, 219, 24, 176, 11, 131, 44, 145, 82, 41, 157, 173, 57, 229, 174, 222,
       191, 248, 145, 2, 90, 142, 0, 212, 117, 73, 96, 215, 203, 122, 32, 141, 205, 16, 208,
       208, 57, 143, 64, 183, 159, 31, 158, 9, 175, 172, 119, 75, 178, 247, 33, 136, 237,
       144, 20, 251, 182, 183, 119, 233, 30, 47, 23, 29, 232, 105, 122, 30, 153, 220, 48, 61,
       246, 128, 76, 62, 109, 215, 250, 215, 73, 200, 184, 138, 98, 199, 167, 185, 189, 59,
       137, 87, 139, 207, 10, 218, 198, 69, 237, 32, 140, 139, 63, 233, 218, 125, 120, 58, 3,
       203, 79, 133, 232, 242, 167, 245, 194, 153, 61, 51, 226, 165, 150, 241, 27, 36, 21, 1,
       200, 78, 224, 39, 133, 162, 52, 77, 122, 50, 33, 30, 15, 41, 161, 242, 189, 28, 245, 150,
       109, 7, 29, 105, 57, 3, 204, 125, 45, 82, 10, 57, 254, 140, 190, 141, 123, 49, 133, 60, 7,
       139, 233, 158, 14, 4, 121, 135, 27, 217, 14, 89, 9, 136, 132, 142, 38, 215, 126, 30, 48,
       240, 45, 77, 154, 167, 227, 2, 217, 223, 65, 116, 157, 85, 7, 148, 157, 5, 219, 234, 51,
       251, 177, 108, 100, 59, 34, 245, 153, 162, 190, 109, 242, 226, 20, 190, 221, 80, 60, 55,
       206, 176, 97, 216, 236, 96, 32, 159, 227, 69, 206, 137, 131, 10, 25, 35, 3, 1, 240, 118,
       202, 255, 0, 77, 25, 38, 9, 103, 3, 47, 203, 247, 118, 209, 175, 201, 133, 248, 136, 119,
       241, 130, 211, 132, 128, 166, 83, 242, 222, 202, 169, 121, 76, 188, 59, 243, 6, 12, 14, 24,
       120, 71, 173, 76, 121, 131, 116, 208, 214, 115, 43, 245, 1, 132, 125, 214, 139, 192, 224,
       113, 36, 30, 2, 19, 188, 127, 193, 61, 183, 171, 48, 76, 251, 209, 224, 138, 112, 74, 153,
       245, 232, 71, 217, 63, 140, 60, 170, 253, 222, 196, 107, 122, 13, 55, 157, 166, 154, 77, 17,
       35, 70, 167, 23, 57, 193, 177, 164, 87, 168, 199, 49, 49, 35, 210, 77, 47, 145, 146, 248, 150,
       183, 198, 62, 234, 5, 169, 213, 127, 6, 84, 122, 208, 206, 200, 10, 54, 58, 11, 138, 191, 186,
       35, 11, 53, 62, 233, 9, 35, 81, 241, 188, 80, 101, 146, 41, 187, 241, 224, 141, 139, 146, 224,
       16, 231, 123, 131, 7, 251, 245, 245, 230, 155, 253, 129, 150, 205, 134, 151, 116, 245, 156, 44,
       9, 19, 187, 133, 153, 139, 69, 244, 118, 207, 148, 89, 131, 208, 226, 64, 25, 142, 147, 147, 146,
       13, 72, 58, 114, 96, 191, 183, 49, 251, 93, 37, 241, 170, 73, 51, 53, 169, 231, 18, 151, 228, 133,
       183, 174, 243, 18, 194, 24, 0, 222, 239, 18, 31, 30, 118, 66, 106, 0, 102, 94, 92, 68, 121, 103, 67,
       34, 212, 247, 94, 218, 221, 70, 222, 189, 92, 217, 146, 246, 237, 9, 6, 137, 208, 88, 95, 240, 117,
       236, 158, 153, 173, 105, 12, 51, 149, 188, 75, 49, 51, 112, 179, 142, 243, 85, 172, 218, 220, 209,
       34, 151, 91, 18, 200, 94, 165, 219, 140, 109, 235, 74, 171, 113, 128, 141, 203, 64, 143, 227, 209,
       231, 105, 12, 67, 211, 123, 76, 230, 204, 1, 102, 250, 125, 170, 44, 218, 50, 20, 200, 45, 102,
       161, 73, 124, 162, 59, 105, 135, 23, 248, 68, 112, 213, 189, 35, 19, 89, 20, 136, 146, 19, 20,
       5, 21, 87, 156, 45, 13, 132, 182, 164, 114, 16, 10, 61, 129, 232, 45, 224, 255, 231, 137, 205,
       19, 60, 62, 75, 170, 93, 214, 245, 71, 242, 136, 163, 115, 25, 193, 3, 176, 60, 213, 239, 250,
       149, 172, 155, 238, 148, 241, 245, 239, 144, 113, 87, 189, 164, 129, 44, 207, 11, 76, 145, 244,
       43, 182, 41, 248, 58, 28, 26, 160, 133, 255, 40, 23, 154, 18, 217, 34, 219, 160, 84, 112, 87,
       204, 170, 233, 75, 157, 105, 207, 170, 78, 96, 64, 31, 234, 127, 62, 3, 51, 17, 12, 16, 19, 79,
       32, 11, 25, 246, 73, 8, 70, 213, 24, 201, 174, 168, 104, 54, 110, 251, 114, 40, 202, 92, 145, 210,
       148, 13, 3, 7, 98, 30, 96, 243, 31, 203, 247, 87, 232, 55, 232, 103, 23, 131, 24, 131, 45, 11, 45,
       116, 213, 158, 47, 234, 28, 113, 66, 223, 24, 125, 63, 198, 211
   ];
   const PAIR_BYTES_LEN: usize = 768;


   let result = unsafe{
       // xrpl_std::host::bn254_pairing_helper(input_bytes.as_ptr(), PAIR_BYTES_LEN)
       bn254_pairing_helper(EXPECTED.as_ptr(), PAIR_BYTES_LEN)
   };
   // let _ = trace_num("  Groth16 proof verfication result with curve BN254:", ok as i64);


   // let result = input_bytes.as_slice() == &EXPECTED[..];
...
//    unsafe{
//        let _ = trace(msg.as_ptr(), msg.len(), mul_buf.as_ptr(), mul_buf.len(), 1);
//    }
...
//     unsafe{
//        let _ = trace(msg.as_ptr(), msg.len(), expected_buf.as_ptr(), expected_buf.len(), 1);
//    }
