...
unsafe extern "C" {
    ...
    pub fn trace(msg_read_ptr: u32, msg_read_len: u32, data_read_ptr: u32, data_read_len: u32, as_hex: u32) -> i64;
    ...
    pub fn get_current_escrow_finish_field(dst_ptr: *const u8, dst_len: usize, field_code: i32);
}
