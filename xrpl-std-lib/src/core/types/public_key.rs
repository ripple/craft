...
mod test_public_key {
    ...
    const PUBKEY_SECP256K1: [u8; 33] = [
        ...
        0x2C, 0xEE, 0x9C, 0xE4, 0x68, 0x0C, 0x33, 0xFF, 0xB3, 0xFF, 0x39, 0xAF, 0xEC, 0xFE, 0x70,
    ];

    // ed25519
    const PUBKEY_ED25519: [u8; 33] = [
        0xED, 0xD9, 0xB3, 0x59, 0x98, 0x02, 0xB2, 0x14, 0xA9, 0x9D, 0x75, 0x77, 0x12, 0xD6, 0xAB, 0xDF, 0x72, 0xF8,
        0x3C, 0x63, 0xBB, 0xD5, 0x38, 0x61, 0x41, 0x17, 0x90, 0xB1, 0x3D, 0x04, 0xB2, 0xC5, 0xC9,
    ];
