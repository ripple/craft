...
use crate::core::params::types::{FuncParamBytes, ParamError, Currency};
...
pub fn get_function_param<T: FuncParamBytes>(index: i32) -> Result<T, ParamError> {
    ...
    let result = unsafe { 
        function_param(index, T::type_code(), buf.as_mut_ptr(), byte_size) 
    };
...
impl FuncParamBytes for UInt160 {
...
impl FuncParamBytes for UInt192 {
...
impl FuncParamBytes for TokenAmount {
