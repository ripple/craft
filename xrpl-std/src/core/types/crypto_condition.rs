...
pub struct Fulfillment(pub [u8; 256]);
...
mod test_public_key {
    ...
    const TEST_CONDITION: [u8; 32] = [
        0x02, 0xC7, 0x38, 0x7F, 0xFC, 0x25, 0xC1, 0x56, 0xCA, 0x7F, 0x8A, 0x6D, 0x76, 0x0C, 0x8D, 0x01, 0xEF, 0x64,
        0x2C, 0xEE, 0x9C, 0xE4, 0x68, 0x0C, 0x33, 0xFF, 0xB3, 0xFF, 0x39, 0xAF, 0xEC, 0xFE,
    ];
